...
# ---------------------------------------------------------------------------
#
#  ATM: 32 nodes and ne128  (so 2x faster)   64.6
#  OCN: 32 nodes (4x slower) and GPUs (10x faster) = 61s
#
TOTAL_PROCS = 52*64   # 128 nodes  64 per node
TOTAL_GPUS = 52*4
...
t_ocn1=t_lnd2
t_ocn2=t_ocn1 + 98.217* (128.0/(OCN_GPUS/4))/10

t_atm1=t_lnd2
t_atm2=t_atm1+129.279/2
